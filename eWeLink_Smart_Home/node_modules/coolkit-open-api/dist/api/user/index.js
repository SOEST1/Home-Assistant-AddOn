...
exports.user = {
    ...
    register(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield utils_1.sendRequest('/v2/user/register', 'POST', params);
        });
    },
    ...
    smsLogin(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield utils_1.sendRequest('/v2/user/sms-login', 'POST', params);
        });
    },
    resetPwd(params) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield utils_1.sendRequest('/v2/user/reset-pwd', 'POST', params);
        });
    },
    closeAccount(params) {
        return __awaiter(this, void 0, void 0, function* () {
