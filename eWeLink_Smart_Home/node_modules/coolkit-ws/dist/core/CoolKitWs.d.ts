import { IConfig, IDeviceConfig, IQueryConfig } from './../ts/interfaces';
import WebSocket from 'ws';
export default class CoolKitWs {
    private static ws;
    init(config: IConfig): Promise<import("../ts/interfaces").IResponse | WebSocket>;
    close(): void;
    updateThing(deviceConfig: IDeviceConfig): Promise<unknown>;
    queryThing(queryConfig: IQueryConfig): Promise<unknown>;
