    ...
    _initWs() {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                const { apikey } = WebSocketService.connectConfig;
                eventEmitter_1.default.once(`${enum_1.EEventType.INIT_WS}${apikey}`, (ev) => resolve(ev));
    ...
    onMessage(ev) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (decodedData.error === 0 && decodedData.config && decodedData.config.hb) {
                ...
                eventEmitter_1.default.emit(`${enum_1.EEventType.INIT_WS}${decodedData.apikey}`, {
                    error: 0,
                    apikey: 'success',
                });
                return;
    ...
    static _sendHandShakeMsg() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (WebSocketService.ws) {
                ...
                console.log(`SL : WebSocketService : _sendHandShakeMsg : params`, params);
    ...
    sendThing(deviceConfig, action) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const deviceParams = {
                ...
                sequence,
                params,
                selfApikey: WebSocketService.connectConfig.apikey
            };
            console.log(`SL : Device : updateThing : deviceParams`, deviceParams);
